...
function testCompletionByEntryStart(testPath, entry, expected) {
    var result = testApi.completionByUniqueEntry(testPath, entry, true);
    assert.equal(result, expected);
}
function testCompletionByEntryEnd(testPath, entry, expected) {
    var result = testApi.completionByUniqueEntry(testPath, entry);
    assert.equal(result, expected);
}
function testCompletionByOffset(testPath, offset, expected) {
    var result = testApi.completionByOffset(testPath, offset);
    assert.equal(result, expected);
}
//# sourceMappingURL=completionTests.js.map