...
var testApi = require('./completionTestApi');
...
function testCompletionByEntryStart(testPath, done, entry, expected) {
    testApi.completionByUniqueEntryAsync(testPath, entry, true, function (result) {
        try {
...
function testCompletionByEntryEnd(testPath, done, entry, expected) {
    testApi.completionByUniqueEntryAsync(testPath, entry, false, function (result) {
        try {
            assert.equal(result, expected);
            done();
        }
...
function testCompletionByOffset(testPath, done, offset, expected) {
    testApi.completionByOffsetAsync(testPath, offset, function (result) {
        try {
            assert.equal(result, expected);
            done();
        }
...
//# sourceMappingURL=asyncCompletionTests.js.map