 ...
 */
export declare function getTemplateParametrizedProperties(node: RamlWrapper.Trait | RamlWrapper.ResourceType | RamlWrapper.Method | RamlWrapper.TypeDeclaration): RamlWrapper.TypeInstance;
