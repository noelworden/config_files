...
export declare function generateMochaSuite(folderAbsPath: string, dstPath: string, dataRoot: string, mochaSuiteTitle: string, libExpand?: boolean, newFormat?: boolean): void;
